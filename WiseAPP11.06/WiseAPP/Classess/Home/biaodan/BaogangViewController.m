...
-(void)addview{
    ...
    if (self.dataArray.count ==0) {
        ...
        self.baogangTabView=[[UITableView alloc]initWithFrame:UIScreenBpunds style:(UITableViewStylePlain)];
       ...
       self.baogangTabView.dataSource = self;
        ...
        [self.baogangTabView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
        //footview
...
-(void)addBtnAction:(UIButton*)sender{
    ...
    BaogangAddViewController* baogangAddVC=[[BaogangAddViewController alloc]init];
    [self.navigationController pushViewController:baogangAddVC animated:YES];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UITableViewCell*cell=[self.baogangTabView dequeueReusableCellWithIdentifier:@"cell"];
