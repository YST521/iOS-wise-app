...
-(void)addview{
        ...
        if (self.dataArray.count ==0) {
            ...
            self.peiXunTableView=[[UITableView alloc]initWithFrame:UIScreenBpunds style:(UITableViewStylePlain)];
            ...
            [self.peiXunTableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
            //footview
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    UITableViewCell*cell=[self.peiXunTableView  dequeueReusableCellWithIdentifier:@"cell"];
