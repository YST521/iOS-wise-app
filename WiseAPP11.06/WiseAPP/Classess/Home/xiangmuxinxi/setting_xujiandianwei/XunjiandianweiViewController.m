...
-(void)addview{
    ...
    if (self.dataArray.count ==0) {
        ...
        self.XunjiandianweiTabView=[[UITableView alloc]initWithFrame:UIScreenBpunds style:(UITableViewStylePlain)];
       ...
       self.XunjiandianweiTabView.delegate = self;
        ...
        [self.XunjiandianweiTabView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
        //footview
...
-(void)addBtnAction:(UIButton*)sender{
    XunjianDainweiAddViewController* xunjianweiAddVC=[[XunjianDainweiAddViewController alloc]init];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    UITableViewCell*cell=[self.XunjiandianweiTabView  dequeueReusableCellWithIdentifier:@"cell"];
